'use strict';
const BoardModel = require('../models/messageBoard.js').Board;
const ThreadModel = require('../models/messageBoard.js').Thread;
const ReplyModel = require('../models/messageBoard.js').Reply;
